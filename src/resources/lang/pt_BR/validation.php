...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'O campo :attribute deve conter um arquivo de no máximo :max KB !!!',
    ...
    'min' => [
        ...
        'file' => 'O campo :attribute deve conter um arquivo de no mínimo :min KB !!!',
        'string' => 'O campo :attribute deve conter no mínimo :min caracteres !!!',
        'array' => 'O campo :attribute deve conter no mínimo :min item !!!',
    ],
    ...
    'size' => [
        ...
        'array' => 'O campo :attribute deve conter :size item !!!',
    ],
